...
**Phase**: Phase B — God-file decomposition (mostly done; TimelineWidget split + CI fix remain)
...
### Phase B — God-file Decomposition (5/6 done)
...
| # | Task | Notes |
|---|------|-------|
| 16 | Split `TimelineWidget.cpp` (2,121 lines) into UI / input / commands | Big, bounded. Has HIGH-02 playback-state-read pattern tangled in. |
...
## Verified Working (as of commit `891b6ae`)
...
3. **Phase B #16 — TimelineWidget split.** Biggest remaining god-file; UI + input + command layers tangled.
4. **Phase B #15c — PlaybackController extraction.** Engine is now ~1,830 lines; playback timing is the last tangled concern.
